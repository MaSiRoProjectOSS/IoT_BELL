...
int AppCue::convert_information(char *data, int start_index, int size, twelite_app_cue::TWELITE_app_cue_msg *msg)
{
    if (start_index < size) {
        // ros::Time     ros_begin  = ros::Time::now();
        // ros::WallTime wall_begin = ros::WallTime::now();
        // msg->Header.stamp = ros::WallTime::now();
...
int AppCue::convert_sensor(char *data, int start_index, int size, twelite_app_cue::TWELITE_app_cue_msg *msg)
{
...
int AppCue::convert_sensor_PAL(char *data, int start_index, int size, twelite_app_cue::TWELITE_app_cue_msg *msg)
{
...
int AppCue::convert_sensor_TAG(char *data, int start_index, int size, twelite_app_cue::TWELITE_app_cue_msg *msg)
{
    // TODO: Set data
    if (start_index < size) {}
    return 12;
...
void AppCue::DebugPrint(twelite_app_cue::TWELITE_app_cue_msg msg)
{
#if 1
    log_printf("==============\n");
